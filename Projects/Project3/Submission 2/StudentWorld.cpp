            ...
            for (int j = 0; j!=32; j++)
            {
                ...
                switch (ge)
                {
                    case Level::empty:
                        break;
                    case Level::koopa:
                        cerr << "Location "<<i<<","<<j<<" starts with a koopa" << endl;
                    ...
                    case Level::goomba:
                        ...
                        cerr << "Location "<<i<<","<<j<<" starts with a goomba" << endl;
                        break;
                    case Level::peach:
                        cerr << "Location "<<i<<","<<j<<" is where Peach starts" << endl;
                        m_peach = new Peach(this, i*SPRITE_WIDTH, j*SPRITE_HEIGHT);
                        break;
                    case Level::block:
                        objects.push_front(new Block(this, i*SPRITE_WIDTH, j*SPRITE_HEIGHT, 0));
                        cerr << "Location "<<i<<","<<j<<" holds a regular block" << endl;
                        break;
                    case Level::star_goodie_block:
                        cerr << "Location "<<i<<","<<j<<" has a star goodie block" << endl;
                        objects.push_front(new Block(this, i*SPRITE_WIDTH, j*SPRITE_HEIGHT, 3));
                        break;
                    case Level::flower_goodie_block:
                        cerr << "Location "<<i<<","<<j<<" has a flower goodie block" << endl;
                        objects.push_front(new Block(this, i*SPRITE_WIDTH, j*SPRITE_HEIGHT, 1));
                        break;
                    case Level::mushroom_goodie_block:
                        cerr << "Location "<<i<<","<<j<<" has a mushroom goodie block" << endl;
